...
(function(){
  ...
  const boostedSet = new Set([
    ...
    grid.innerHTML = limited.map(item => {
      ...
      // Only for AI & ML category, render a subtle top-left badge on images
      const catKeyLower = (category||'').toString().toLowerCase();
      const isAiMl = (catKeyLower === 'ai & ml') || (catKeyLower === 'ai and ml') || (catKeyLower === 'ai');
